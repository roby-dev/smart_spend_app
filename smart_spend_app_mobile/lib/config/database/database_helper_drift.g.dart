...
class $ComprasTable extends Compras with TableInfo<$ComprasTable, Compra> {
  ...
  static const VerificationMeta _presupuestoMeta = const VerificationMeta(
    'presupuesto',
  );
  @override
  ...
  Compra map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Compra(
      ...
      presupuesto: attachedDatabase.typeMapping.read(
        DriftSqlType.double,
        data['${effectivePrefix}presupuesto'],
      ),
...
class Compra extends DataClass implements Insertable<Compra> {
  ...
  Compra copyWithCompanion(ComprasCompanion data) {
    return Compra(
      ...
      presupuesto: data.presupuesto.present
...
class $CompraDetallesTable extends CompraDetalles
  ...
  CompraDetalle map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CompraDetalle(
      ...
      compra: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}compra'],
      )!,
    );
  }
...
final class $$ComprasTableReferences
  ...
  _comprasTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.compraDetalles,
    aliasName: $_aliasNameGenerator(db.compras.id, db.compraDetalles.compra),
  );
  ...
  $$CompraDetallesTableProcessedTableManager get compras {
    final manager = $$CompraDetallesTableTableManager(
      $_db,
      $_db.compraDetalles,
    ).filter((f) => f.compra.id.sqlEquals($_itemColumn<int>('id')!));
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (compras)
                    ...
                    >(
                      currentTable: table,
                      referencedTable: $$ComprasTableReferences._comprasTable(
                        db,
                      ),
...
final class $$CompraDetallesTableReferences
  ...
  $$ComprasTableProcessedTableManager get compra {
    final $_column = $_itemColumn<int>('compra')!;
